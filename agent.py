...
SYSTEM_PROMPT = """
You are a helpful Agentic AI assistant named Chatbot similar to ChatGPT.
...
def normlize_model_name(model_name:str | None) -> str:
    """
...
def build_agent(model_name:str):
    ...
    selected_model = normlize_model_name(model_name)
...
def get_agent(model_name:str | None=None):
    ...
    select_model = normlize_model_name(model_name)
    
    if select_model not in _AGENT_CACHE:
        _AGENT_CACHE[select_model]=build_agent(select_model)
    
    return _AGENT_CACHE[select_model]
